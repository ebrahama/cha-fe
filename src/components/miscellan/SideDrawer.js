...
import ChatLoading from "../chatload";
import { Spinner } from "@chakra-ui/spinner";
import UserListItem from "../userava/userlist";
...
return(
    ...
    >
      ...
      <div>
        <Menu>
          <MenuButton as={Button} bg="#48BB78" rightIcon={<ChevronDownIcon/>}>
        ...
        <DrawerContent opacity="0.9">
          ...
          <DrawerBody>
            <Box display="flex" pb={2}>
              ...
              />
              <Button onClick={handleSearch}><Icon as={RepeatIcon} /></Button>
            </Box>
            {loading ? (
              <ChatLoading />
            ) : (
